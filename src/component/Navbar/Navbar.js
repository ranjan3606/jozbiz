                ...
                <div className="container navigation">
                    ...
                    <div className="collapse navbar-collapse ms-auto col-sm-12" id="navbarSupportedContent">
                        <ul className="navbar-nav ms-auto mb-2 mb-lg-0">
                            ...
                            <li className="nav-item">
                                <div className='login'><a className="nav-link btn text-dark" aria-current="page" href="/">Log In <svg className='svg' xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-chevron-right" viewBox="0 0 16 16">
